...
public class GraficaSemana extends AppCompatActivity {
    ...
    int[] toxicidad = new int[]{10,15,20};
    int[] colors = new int[]{Color.GREEN,Color.BLUE,Color.YELLOW};

    /*
        String[] diasSeam = new String[]{"0","0","0","0","0","0","0"};
    int[] toxicidad = new int[]{10,15,20};
    int[] colors = new int[]{Color.GREEN,Color.BLUE,Color.YELLOW};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafica_semana);
